...
export const translations = {
  en: {
    ...
    // Preset descriptions
    presetFreeTierDesc: "Perfect for learning, testing, and low-traffic projects",
    ...
    compare: {
      ...
      subtitle: "Select 1 to 3 analyses to view and compare",
      backToHome: "Back to Home",
      back: "Back",
      noAnalyses: "No saved analyses yet. Run a comparison and save it to see it here!",
      startNewAnalysis: "Start New Analysis",
      ...
      show: "Show",
      share: "Share",
      metricsComparison: "Metrics Comparison (Radar)",
      metricsComparisonDesc: "Visual comparison across all metrics",
      costComparisonChart: "Cost Comparison (Bar)",
      costComparisonChartDesc: "Monthly costs at 10M messages/month",
      sideBySide: "Side-by-Side Comparison",
      comparingAnalyses: "Comparing {count} analyses",
      metric: "Metric",
      date: "Date",
      region: "Region",
      sqsCost: "SQS Cost",
      sqsCostDetail: "SQS Cost (10M msgs)",
      kafkaCost: "Kafka Cost",
      kafkaCostDetail: "Kafka Cost (10M msgs)",
      linkCopied: "Link copied!",
      linkCopiedDesc: "Paste to share",
      comparingText: "Comparing {count} analyses on QueueAdvisor",
      costLabel: "Cost ($)",
      costSummary: "Cost Summary",
      monthlyCostAt10M: "Monthly cost at 10M msgs/month",
      cheaper: "cheaper",
  ...
  pt: {
    ...
    // Preset descriptions
    presetFreeTierDesc: "Perfeito para aprender, testar e projetos de baixo tráfego",
    ...
    compare: {
      ...
      subtitle: "Selecione de 1 a 3 análises para visualizar e comparar",
      backToHome: "Voltar ao Início",
      back: "Voltar",
      noAnalyses: "Nenhuma análise salva ainda. Execute uma comparação e salve para ver aqui!",
      startNewAnalysis: "Iniciar Nova Análise",
      ...
      show: "Mostrar",
      share: "Compartilhar",
      metricsComparison: "Comparação de Métricas (Radar)",
      metricsComparisonDesc: "Comparação visual entre todas as métricas",
      costComparisonChart: "Comparação de Custos (Barras)",
      costComparisonChartDesc: "Custos mensais com 10M mensagens/mês",
      sideBySide: "Comparação Lado a Lado",
      comparingAnalyses: "Comparando {count} análises",
      metric: "Métrica",
      date: "Data",
      region: "Região",
      sqsCost: "Custo SQS",
      sqsCostDetail: "Custo SQS (10M msgs)",
      kafkaCost: "Custo Kafka",
      kafkaCostDetail: "Custo Kafka (10M msgs)",
      linkCopied: "Link copiado!",
      linkCopiedDesc: "Cole para compartilhar",
      comparingText: "Comparando {count} análises no QueueAdvisor",
      costLabel: "Custo ($)",
      costSummary: "Resumo de Custos",
      monthlyCostAt10M: "Custo mensal com 10M msgs/mês",
      cheaper: "mais barato",
